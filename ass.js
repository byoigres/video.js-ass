var video_container = document.getElementById('subs');
(function (global, factory) {
  ...
  function createDialogue(dialogue) {
    ...
    slices.forEach(function (slice) {
      ...
      slice.fragments.forEach(function (fragment) {
        ...
        var vct = this$1._.videojs ? this$1._.videojs.currentTime() : this$1.video.currentTime;
        if (!drawing) {
  ...
  function allocate(dialogue) {
    ...
    // VIDEOJS
    var vct = this._.videojs ? this._.videojs.currentTime() : this.video.currentTime;
    var vct = (this._.videojs ? this._.videojs.currentTime() : this.video.currentTime) * 100;
  ...
  function init(source, video, options) {
    ...
    if (!this._.hasInitContainer) {
      ...
      video_container.parentNode.insertBefore(this.container, video_container);
      // TODO: END FIX THIS
      // TODO: FIX THIS
      // this.container.appendChild(video);
      this.container.appendChild(video_container);
      // TODO: END FIX THIS
